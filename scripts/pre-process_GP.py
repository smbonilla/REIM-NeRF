...
import shutil
from reimnerf.datasets.preprocessing.raw_data import GP_Dataset, remove_json_fames ,keep_only_json_fames
import argparse
import warnings
    ...
    for ds_p in dataset_paths:
        ...
        try:
            ...
            if args.overwrite:
                ...
                continue
        gp_dataset = GP_Dataset(ds_p)
        gp_dataset._normalize_dataset()

        gp_dataset.export_reim(target_dir, step=1, suffix='test', save_images=True)
